...
<body>
	<table align="center" style="border:1px solid blue;">
		...
		<tr>
			<td>Search In: </td>
				<td>
					<select name="searchon" method="get" multiple>
		...
		<tr>
			<td>Category: </td>
				<td><select name="category">
						...
						<option value='1'>Fantasy</option><option value='2'>Adventure</option><option value='3'>Fiction</option><option value='4'>Textbook</option>				</select></td>
				</form>
